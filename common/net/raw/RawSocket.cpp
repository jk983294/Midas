...
static int set_nonblock(int fdSocket) {
    int rc = 0;
...
ssize_t send_udp(int fdSocket, uint8_t const *buf, std::size_t numBytes, char const *addrRemote, uint16_t portRemote) {
    MIDAS_LOG_INFO("(" << addrRemote << ":" << portRemote << "})");
